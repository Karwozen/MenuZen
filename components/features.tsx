      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="group relative bg-[#1a0b02]/60 backdrop-blur-xl backdrop-saturate-150 border border-orange-500/20 shadow-[0_8px_30px_rgba(234,88,12,0.05)] p-8 sm:p-10 rounded-3xl hover:-translate-y-2 hover:border-orange-500/60 hover:shadow-[0_0_40px_rgba(234,88,12,0.2)] hover:bg-[#2a1204]/80 duration-500 transition-all overflow-hidden"
            >
              ...
              <div className="mb-6 inline-flex bg-gradient-to-br from-amber-500/20 to-red-500/20 border border-white/20 p-3 rounded-2xl shadow-lg backdrop-blur-md text-orange-500 drop-shadow-[0_0_15px_rgba(245,158,11,0.5)] group-hover:text-amber-300 transition-all duration-500 relative z-10">
