  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-indigo-900/40 via-[#0a0a0a] to-emerald-900/20 border border-white/10 p-8 md:p-12 lg:p-16 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 relative">
                <div className="absolute -left-3 -top-3 bg-indigo-500 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold shadow-lg shadow-indigo-500/30">1</div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-6 relative">
                <div className="absolute -left-3 -top-3 bg-emerald-500 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-lg shadow-emerald-500/30">2</div>
                <blockquote className="italic text-emerald-100/80 mb-3 border-l-2 border-emerald-500/30 pl-4 py-1">
              ...
              <div className="relative w-full max-w-sm">
                ...
                <div className="bg-white/5 border border-white/10 rounded-3xl p-4 shadow-2xl backdrop-blur-sm relative z-0">
                  <div className="bg-[#111] rounded-2xl p-6 flex flex-col items-center gap-4 border border-white/5">
                    ...
                    <div className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl p-0.5 shadow-lg">
                      <div className="w-full bg-[#111] rounded-xl p-4 flex flex-col items-center text-center">
                        <div className="bg-indigo-500/20 w-16 h-16 flex items-center justify-center rounded-xl mb-3 border border-indigo-500/30">
                ...
                {/* Floating elements */}
                <div className="absolute -bottom-6 -right-6 bg-[#0a0a0a] border border-emerald-500/30 shadow-xl rounded-2xl p-4 flex items-center gap-3 z-20 animate-bounce" style={{ animationDuration: '3s' }}>
                  <div className="bg-emerald-500/20 w-10 h-10 rounded-full flex items-center justify-center">
                    <span className="text-emerald-500 font-bold">+17%</span>
                  </div>
                  <div>
